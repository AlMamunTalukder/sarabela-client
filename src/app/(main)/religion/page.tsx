...
<<<<<<< HEAD
          <TopNews category={category} basePath="/religion" />
          <Advertisement banner={banner} />
          <OtherNews category={category} basePath="/religion" />
=======
          <TopNews basePath="/religion" />
          <Advertisement_2 banner={banner} />
          <OtherNews basePath="/religion"/>
>>>>>>> d97df043daae41a8a4c9c5112b6460456e1b3796
        </div>
        <div className="w-full lg:w-1/4 lg:sticky lg:top-20 lg:self-start lg:order-2 order-1">
          <SideTabs category={category} basePath="/religion" />
        </div>
      </div>
    </div>
  );
