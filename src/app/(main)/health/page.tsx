...
<<<<<<< HEAD
          <TopNews category={category} basePath="/health" />
          <Advertisement banner={banner} />
          <OtherNews category={category} basePath="/health" />
=======
          <TopNews basePath="/health" />
          <Advertisement_2 banner={banner} />
          <OtherNews basePath="/health"/>
>>>>>>> d97df043daae41a8a4c9c5112b6460456e1b3796
        </div>
        <div className="w-full lg:w-1/4 lg:sticky lg:top-20 lg:self-start lg:order-2 order-1">
          <SideTabs category={category} basePath="/health" />
        </div>
      </div>
    </div>
  );
