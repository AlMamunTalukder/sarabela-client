...
<<<<<<< HEAD
          <TopNews category={category} basePath="/entertainment" />
          <Advertisement banner={banner} />
          <OtherNews category={category} basePath="/entertainment" />
=======
          <TopNews basePath="/entertainment"/>
          <Advertisement_2 banner={banner} />
          <OtherNews basePath="/entertainment"/>
>>>>>>> d97df043daae41a8a4c9c5112b6460456e1b3796
        </div>
        <div className="w-full lg:w-1/4 lg:sticky lg:top-20 lg:self-start lg:order-2 order-1">
          <SideTabs category={category} basePath="/entertainment" />
        </div>
      </div>
    </div>
  );
