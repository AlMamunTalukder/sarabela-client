  ...
  return (
    <div className="flex items-center gap-2 justify-end mt-10 flex-wrap">
      ...
      <Button
        ...
        className="bg-[#1877F2] hover:bg-[#344e86] h-6 lg:h-8 w-6 lg:w-8 rounded-full p-0"
      >
      ...
      <Button
        ...
        className="bg-[#0084ff] hover:bg-[#0074e0] h-6 lg:h-8 w-6 lg:w-8 rounded-full p-0"
      >
      
        <FaFacebookMessenger className="h-2 lg:h-4 w-2 lg:w-4 text-white" />
      </Button>
      ...
      <Button
        ...
        className="bg-[#25D366] hover:bg-[#21bd5a] h-6 lg:h-8 w-6 lg:w-8 rounded-full p-0"
      >
      ...
      <Button
        ...
        className="bg-black hover:bg-gray-800 h-6 lg:h-8 w-6 lg:w-8 rounded-full p-0"
      >
      ...
      <Button
        ...
        className="bg-[#0077b5] hover:bg-[#006399] h-6 lg:h-8 w-6 lg:w-8 rounded-full p-0"
      >
      ...
      <Button
        ...
        className="dark:bg-gray-500 bg-gray-800 hover:bg-gray-700 h-6 lg:h-8 w-6 lg:w-8 rounded-full p-0"
      >
